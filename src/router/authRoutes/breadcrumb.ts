  ...
  children: [
    {
      ...
      path: 'list1',
      component: () => import('@/modules/Demo/Breadcrumb/views/list1.vue'),
      meta: {
        title: '平级导航模式（列表页1）',
    ...
    },
    {
      ...
      path: 'detail1',
      component: () => import('@/modules/Demo/Breadcrumb/views/detail1.vue'),
      meta: {
        title: '平级导航模式（详情页1）',
      ...
      children: [
        {
          name: 'BreadcrumbDemoList2',
          path: '',
          component: () => import('@/modules/Demo/Breadcrumb/views/list2.vue'),
          meta: {
            title: '层级导航模式（列表页2）',
