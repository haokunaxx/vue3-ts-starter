<template>
  ...
  <template v-else>
    ...
    <span
      ...
      :class="[
        $attrs.class,
        'iconify-wrap preset-icon',
        spin && 'iconify-wrap-spin'
      ]"
      :style="getStyle"
    ></span>
  </template>
...
export default defineComponent({
  ...
  props: {
    ...
    useIconfont: propTypes.bool.def(false)
  },
  components: {
    SvgIcon
  },
  setup(props) {
    ...
    const isIconfont = computed(() => !unref(isSvgIcon) && props.useIconfont)
